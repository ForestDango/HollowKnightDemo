...
{
    private float lastPositionY, fallDistance;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        audioPlayer.Play(HeroAudioController.AudioType.Falling, true);
    }
    ...
    {
        audioPlayer.Play(HeroAudioController.AudioType.Falling, false);
    }
